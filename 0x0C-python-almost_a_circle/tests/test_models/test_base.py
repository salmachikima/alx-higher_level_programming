...
class TestBase(unittest.TestCase):
    ...
    def setUp(self):
        '''Importing module instantiates class'''
        Base._Base__nb_objects = 0
        pass

    def tearDown(self):
        '''Cleaning after test_method'''
        pass

    def test_A_nb_objects_private(self):
        '''Tests if nb_objectsis a private class attribute'''
    ...
    def test_D_constructor_args_2(self):
        '''Tests constructor signature with two notself args'''
        with self.assertRaises(TypeError) as e:
